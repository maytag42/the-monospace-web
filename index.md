...
I'm not sure.
But I like them, and that's why I started experimenting with exclusively monospace Web pages.

On this page, I use a monospace grid to align text and draw diagrams.
It's generated from a simple Markdown document (using Pandoc); a CSS and a tiny bit of Javascript renders the Markdown onto the grid.
The resulting page is responsive, shrinking and growing in character-sized steps.
...
That's it for now.
I've very much enjoyed making this, refining my CSS chops and having a lot of fun with the design.
